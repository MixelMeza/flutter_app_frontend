...
class _RegisterVersion7State extends State<RegisterVersion7> {
    ...
    return Column(
      ...
      children: [
                ...
                children: [
                  ...
                  Builder(
                    builder: (ctx2) {
                      ...
                      final currentValue = sexoOptions.contains(_sexo)
                          ? _sexo
                          : null;
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            labelText: 'Tel. apoderado (opcional)',
            prefixIcon: Icon(
              Icons.phone_android,
              color: borderColor.withAlpha((0.9 * 255).round()),
            ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: isDark
                ? AppColors.midnightBlue.withAlpha((0.08 * 255).round())
                : AppColors.midnightBlue.withAlpha((0.04 * 255).round()),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Column(
                      ...
                      if (narrow) ...[
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelText:
                                'Nombre de usuario (opcional) - usado para iniciar sesión',
                          ),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.note, color: borderColor.withOpacity(0.9)),
          ),
          maxLines: 3,
        ),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: _rol == 'propietario'
                          ? buttonColor
                          : borderColor.withOpacity(0.12),
                      width: _rol == 'propietario' ? 2 : 1,
                    ),
                    color: _rol == 'propietario'
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: _rol == 'inquilino'
                          ? buttonColor
                          : borderColor.withOpacity(0.12),
                      width: _rol == 'inquilino' ? 2 : 1,
                    ),
                    color: _rol == 'inquilino'
                        ? buttonColor.withOpacity(0.06)
                        : Colors.transparent,
  ...
  void _submit() {
    ...
    final data = <String, dynamic>{
      ...
      'telefono_apoderado': _telefonoApoderadoCtrl.text.trim().isEmpty
          ? null
          : _telefonoApoderadoCtrl.text.trim(),
